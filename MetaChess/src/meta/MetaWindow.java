...
public class MetaWindow {
    ...
    private static void setNatives() {
        ...
        switch (LWJGLUtil.getPlatform()) {
            case WINDOWS: {
                JGLLib = Paths.get("lib", "lwjgl", "native", "windows", sysArchFolder);
            }
            break;

            case LINUX: {
                JGLLib = Paths.get("lib", "lwjgl", "native", "linux", sysArchFolder);
            }
            break;

            case MACOSX: {
                JGLLib = Paths.get("lib", "lwjgl", "native", "macosx", sysArchFolder);
            }
            break;
        }
